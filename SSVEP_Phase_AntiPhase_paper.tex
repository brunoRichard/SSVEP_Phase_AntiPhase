...
Two-Stage with parallel monocular channels & 0.902 & 0.675 & 122.87 \\
Two-Stage with phase-selective channels \& monocular channels & 0.904 &
0.668 & 121.60 \\
\end{longtable}
...
observer SSVEP. Nevertheless, the addition of spatial phase selectivity
may improve our ability to describe observer SSVEPs. We added
phase-selectivity to the binocular and monocular channels in the
two-stage contrast gain control model, which required replicating the
equations from both stages to have binocular and monocular channels
