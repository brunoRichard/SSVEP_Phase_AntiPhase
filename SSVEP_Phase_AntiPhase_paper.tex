...
Campbell and Green, 1965; Meese et al., 2006). Contrast
...
than a binocular one. The binocular improvement in sensitivity
...
binocular advantage. The new parameter, S, is included to set
...
differenced. Early approaches (Campbell and Green, 1965)
...
2007). Using both stimulation protocols yields the data needed
...
authors BR and DHB, participated in this study. The sample size
...
York. Finally, as the experimental design was exploratory in
...
2021; Richard et al., 2018). While other computational
...
control model, as defined by Georgeson et al. (2016). Our goal
