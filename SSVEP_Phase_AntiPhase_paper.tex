...
its variants - to capture our neural data. Presenting stimuli in
...
successfully applied to neural data collected under a large variety of
...
Computationally, we found that parallel monocular channels were required
to explain the SNR spectra of our observers in the two-temporal
anti-phase conditions under On/Off flicker. Without the addition of
monocular channels, the models could not generate a response at the
fundamental (3Hz) or its odd integer harmonics. While an important
inclusion in our study, the addition of monocular channels did not
meaningfully improve the ability of the two-stage contrast gain control
model to capture the SNR spectra of the other experimental conditions.
