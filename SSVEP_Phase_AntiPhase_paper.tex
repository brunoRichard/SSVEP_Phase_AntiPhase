...
Campbell and Green, 1965; Meese et al., 2006). \textbf{Contrast
...
than a binocular one. \textbf{The binocular improvement in sensitivity
...
binocular advantage. \textbf{The new parameter, S, is included to set
...
differenced. \textbf{Early approaches (Campbell and Green, 1965)
...
(`dipper') functions. \textbf{As with the parameter S in
...
2007). \textbf{Using both stimulation protocols yields the data needed
...
authors BR and DHB, participated in this study. \textbf{The sample size
...
York. \textbf{Finally, as the experimental design was exploratory in
...
2021; Richard et al., 2018). \textbf{While other computational
...
control model, as defined by Georgeson et al. (2016). \textbf{Our goal
