...
Computationally, we found that parallel monocular channels were required to explain the SNR spectra of our observers in the two-temporal anti-phase conditions under On/Off flicker. Without the addition of monocular channels, the models could not generate a response at the fundamental (3Hz) or its odd integer harmonics. While an important inclusion to our study, the addition of monocular channels did not meaningfully alter the ability of the two-stage contrast gain control model to capture observer SNRs in the other experimental conditions. The monocular contributions to the model output are largest when the stimulus contrast between the two eyes differ [@Georgeson2016], experimental conditions that we did not explore here. 

Whether the presence of the monocular response in the SSVEP of observers indicates they contribute to perception is unclear. There are correlations between the amplitude of SSVEPs and perceptual sensitivity which allow for the extraction of perceptual thresholds via linear extrapolation [@Campbell1972;@norcia2015].  

#### Spatial Phase

While spatial phase does impact binocular combination psychophysically [@BakerMeese2007; @Simmons2005; @Bacon1976], we have little evidence that it meaningfully altered SSVEPs in our observers. \# Conclusion

The two-stage contrast gain control model remains a powerful and flexible descriptor of the architecture of binocular combination for data collected across many experimental conditions and modalities.

#### The modelling

we demonstrate that many mechanisms of binocular combination, such as monocular non-linearities, interocular interactions, and parallel monocular channels, are required to explain neural responses to our set of experimental conditions.
