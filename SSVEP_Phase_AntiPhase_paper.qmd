...
| Parameter | Value |
|:----------|:-----:|
| m         | `r round(exp(twoStageWithMonocChannels.params$par[1]),2)` |
| p         | `r round(exp(twoStageWithMonocChannels.params$par[2]),2)` |
| q         | `r round(exp(twoStageWithMonocChannels.params$par[3]),2)` |
| S         | `r round(exp(twoStageWithMonocChannels.params$par[4]),2)` |
| Z         | `r round(exp(twoStageWithMonocChannels.params$par[5]),2)` |
...
![A diagram that shows the effect of summing a rectified wave.](Figures/SumDiagram.png){#fig-sumDiagram}
